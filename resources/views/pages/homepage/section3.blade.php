<section class="ftco-no-pb gallery">
    <div class="container">
        <div class="row justify-content-start mb-5 pb-2">
            <div class="col-md-4 heading-section ftco-animate">
                <span class="subheading subheading-with-line"><small class="pr-2 bg-white">Product</small></span>
            ...
            <div class="col-md-8 pl-md-5 heading-section ftco-animate">
                <div class="pl-md-4 border-line ">  
                    ...
                    <div class="category mt-5 gallery-filter">
                        ...
                        <span class="filter-item mr-2" data-filter="product-b">Product B</span>
                        <span class="filter-item mr-2" data-filter="product-c">Product C</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-wrap">
        <div class="row no-gutters">
            <div class="col-md-6 col-lg-3 ftco-animate gallery-item product-a">
                <div class="project">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate gallery-item product-b">
                <div class="project">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate gallery-item product-c">
                <div class="project">
